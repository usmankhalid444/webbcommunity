  ...
  <div>
    <AdminProfileLayout>
      ...
      <div class="w-full relative">
        ...
        <router-link to="createannouncement">
          <button
      ...
      <div class="w-full bg-white mt-10 p-5 relative">
        <ul>
          <li class="inline font-bold  ">
            <p
              @click="currentTab = 'allAnnouncements'"
      ...
      <AllAnnouncements v-if="currentTab === 'allAnnouncements'" />
      <Draft v-if="currentTab === 'draft'" />
      <Trash v-if="currentTab === 'trash'" />
    </AdminProfileLayout>
  </div>
</template>
<script>
...
export default {
  components: { AllAnnouncements, Draft, Trash },
  data() {
    return {
      currentTab: "allAnnouncements",
    };
