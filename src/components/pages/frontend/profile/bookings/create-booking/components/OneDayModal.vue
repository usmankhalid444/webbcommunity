<template>
  <vue-final-modal
    ...
    content-class="w-full xl:w-5/6 relative max-h-full mx-4 md:p-12 p-5 border rounded bg-white"
  >
    <div
      class="grid grid-cols-12 gap-x-4 md:gap-x-8 text-custom-darkblue mx-auto xl:max-w-7xl"
    >
      <!-- calender section -->
      <div class="col-span-12 md:col-span-7 xl:col-span-9">
        <p @click="close" class="cursor-pointer inline">
