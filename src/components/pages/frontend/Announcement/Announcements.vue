    ...
    <div class="w-full bg-white mt-10 p-5 relative">
      <ul>
        <li class="inline font-bold  ">
          <p class="inline cursor-pointer pr-5 py-5 text-custom-darkblue">
        ...
        <li class="inline  font-bold">
          <p class="inline cursor-pointer px-5 py-5 text-custom-lightgray">
            <Link href="/admin/announcements/draft">
              Draft
            </Link>
          </p>
        </li>
        <li class="inline font-bold text-custom-lightgray">
...
<script>
import AdminProfileLayout from "../../../layouts/admin/profile-layout/AdminProfileLayout";
// import Pagination from "@/GlobalComponents/Pagination";
export default {
  layout: AdminProfileLayout,
  props: ["announcements", "filters"],
