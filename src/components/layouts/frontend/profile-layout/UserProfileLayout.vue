<template>
  <div class="min-h-screen bg-custom-lightgreen ">
    <Header darkHeader="true" />
    <UserProfileLayoutMobile :menu="menu" />
    <div
      class="hidden h-screen bg-white md:block text-custom-lightblue capitalize font-semibold border-r border-gray-300 w-72  fixed"
    >
    ...
    <div class="p-3 md:p-14 w-full md:w-auto md:ml-72">
